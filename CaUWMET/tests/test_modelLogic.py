...
class waterBalanceLogicTests(TestCase): #this class is inheriting functionality of the unittest.TestCase class
    ...
    def testModelLogic(self):
        ...
        self.assertEqual(self.modelLogic.waterMarketTransferCost_Contractor[0], 670350.3682319999)
        ...
        self.assertEqual(self.modelLogic.reliabilityManagementCost_Contractor[0], 735984213.2243636)
