...
nodeMappingFileName = "inputData_FullContractorList/contractorInfo_calsimLinkage.csv"
...
outputFileName = "inputData_FullContractorList/test__swpCVPSupplyData" + inputDSSFileName + ".csv"
