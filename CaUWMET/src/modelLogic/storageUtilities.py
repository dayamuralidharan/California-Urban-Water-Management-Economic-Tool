...
def putOrTakeFromStorage(i, 
    ...
    if excessSupply_Contractor[i] > 0:
        ...
        if excessSupply_Contractor[i] > 0 and excessSupplySwitch_Contractor in ["Put into Carryover and Groundwater Bank", "Put into Carryover Storage"]:
            ...
            volumeSurfaceCarryover_Contractor[i] = volumeSurfaceCarryover_Contractor[i] + putSurface_Contractor
    else:
    ...
    if volumeSurfaceCarryover_Contractor[i] > 0:
        ...
        pctStorageCalledSurfaceCarryover_Contractor = (demandsToBeMetByCarryover_Contractor[i] / volumeSurfaceCarryover_Contractor[i])
    ...
    if demandsToBeMetByCarryover_Contractor[i] > 0:
        if volumeSurfaceCarryover_Contractor[i] > 0:
            ...
            if storageHedgingStrategySwitch_Contractor in ["Surface Carryover Only", "Surface and Groundwater Storage"]:
                ...
                takeSurface_Contractor = min(volumeSurfaceCarryover_Contractor[i], demandsToBeMetByCarryover_Contractor[i], surfaceMaximumTakeCapacity_Contractor)
    else:
        takeSurface_Contractor = 0
            
    volumeSurfaceCarryover_Contractor[i] = volumeSurfaceCarryover_Contractor[i] - takeSurface_Contractor
    ...
    volumeGroundwaterBank_Contractor[i] = volumeGroundwaterBank_Contractor[i] - takeGroundwater_Contractor
