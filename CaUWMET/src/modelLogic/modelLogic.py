...
def doNotImplementContingencyWMOs(contingentConservationUseReductionVolume, waterMarketTransferDeliveries,totalShortage):
    contingentConservationUseReductionVolume.append(0)
    waterMarketTransferDeliveries.append(0)
    totalShortage.append(0)
    
def deliverWaterMarketTransfers(contractor, i, totalShortage, demandsToBeMetByWaterMarketTransfers, transferLimit,waterMarketTransferDeliveries):
    ...
    for contractor in contractorsList:
        ...
        ## If there is remaining demand and storage is below user-defined threshold, implement contingency conservation and water market transfers assumptions:
            ...
            if demandsToBeMetByContingentOptions_Contractor[i] > 0.0:
                #implementContingencyConservation
                ...
                if  shortagePortionOfTotalAppliedDemand > shortageThresholdForWaterMarketTransfers_Contractor:
                    deliverWaterMarketTransfers(contractor, i, totalShortage_Contractor, demandsToBeMetByWaterMarketTransfers_Contractor, transferLimit,waterMarketTransferDeliveries_Contractor)
            else:
                doNotImplementContingencyWMOs(contingentConservationUseReductionVolume_Contractor, waterMarketTransferDeliveries_Contractor,totalShortage_Contractor)
